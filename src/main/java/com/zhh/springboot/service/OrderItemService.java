...
import com.zhh.springboot.dao.OrderItemDao;
...
public class OrderItemService {
    ...
    public OrderItem get(int id) {
        ...
        Optional<OrderItem> one = orderItemDao.findById(id);
        System.out.println(one.get().getProduct().getId());
        return one.get();
    }

    @CacheEvict(allEntries=true)
    public void delete(int id) {
//        System.out.println(id+"1111111111111111111111111111111");
